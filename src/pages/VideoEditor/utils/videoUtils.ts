...
export const mergeRanges = (rs: Range[], eps = 0.01): Range[] => {
...
export const detectSilences = (probe: Probe, peaks: number[], minSeconds: number): Range[] => {
...
export const tightenSilences = (probe: Probe, peaks: number[], minSeconds: number, leaveMs = 150): Range[] => {
  const spans = detectSilences(probe, peaks, minSeconds);
