...
export function TrackControls({ track, onUpdateTrack, onDeleteTrack, height }: TrackControlsProps) {
  ...
  return (
    <div 
      className={`flex flex-col gap-1 px-2 py-1 border-b border-slate-700 bg-slate-800 hover:bg-slate-750 transition-colors group`}
          ...
          {isEditing ? (
            <div className="flex items-center gap-1">
              <input
                ...
                className="flex-1 px-3 py-2 text-base bg-slate-700 text-white border border-slate-600 rounded focus:outline-none focus:border-blue-500"
                maxLength={25}
              />
              <button
